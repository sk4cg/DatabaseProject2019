<?php
        ...
        if($stmt->prepare("select artist, date, time, price, genre, name, street, city, state, capacity from concert natural join concert_venue natural join place natural join holds where name like ?") or die(mysqli_error($db))) {

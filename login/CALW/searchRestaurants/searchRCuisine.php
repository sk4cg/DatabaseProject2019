<?php
        ...
        if($stmt->prepare("select name, ambiance, cuisine, price, menu, street, city, state from restaurant natural join place where cuisine like ?") or die(mysqli_error($db))) {
